...
function parseUrl(search) {
  ...
  for (var i = 0; i < searchs.length; i++) {
    if (!string.isEmpty(searchs[i])) {
      var v = searchs[i].split('=');

      if (!string.isEmpty(v[0])) {
        var v0 = decodeURIComponent(v[0]);
        var v1 = string.isEmpty(v[1]) ? '' : decodeURIComponent(v[1]);
        query[v0] = v1;
      }
    }
  }
...
function () {
  ...
  onError) {
    ...
    var l = utils.mergeMap(location, p);
    l.query = utils.mergeMap(p.query, location.query);
...
var isHtmlDom = dom$1.isDom;
var getViewPort = dom$1.getViewPort;
var getDocumentPort = dom$1.getDocumentPort;
var getDocumentOffset = dom$1.getDocumentOffset;
var getElementOffset = dom$1.getElementOffset;
var addEventListener = dom$1.addEventListener;
var removeEventListener = dom$1.removeEventListener; // function probeDom(maxTime:Number, condition:()=>boolean) {
...
var browserIsMobile = utils.browserIsMobile;
/**
 * @desc: the browser is ios.
 */

var browserIsIOS = utils.browserIsIOS;
/**
 * @desc: the browser is phone.
 */

var browserIsPhone = utils.browserIsPhone;
/**
 * @desc: the browser is weixin.
 */

var browserIsWeixin = utils.browserIsWeixin;
/**
 * @desc: 判断是否是ie.
 */

var browserIsIE = utils.browserIsIE;
/**
 * @desc: 判断ie版本号.
...
var browserIEVer = utils.browserIEVer;
/**
 * @desc: the browser is support html5.
 */

var browserIsSupportHtml5 = utils.browserIsSupportHtml5;
var browserIsSafari = utils.browserIsSafari;
var browserIsOpera = utils.browserIsOpera;
var browserIsFirefox = utils.browserIsFirefox;
var browserIsChrome = utils.browserIsChrome;
var browserIsEdge = utils.browserIsEdge;
