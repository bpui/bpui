...
import bpLibs$1 from '@bpui/libs';
...
var script = {
  ...
  beforeMount: function beforeMount() {
    this.isMobile = utils.browserIsMobile();
  ...
  methods: {
    ...
    getSelect: function getSelect() {
      ...
      if (data) {
        ...
        if (data[index]) {
          return utils.mergeMap(data[index]);
        }

        return data[0] ? utils.mergeMap(data[0]) : {};
      } // if.
    ...
    _bindEvent: function _bindEvent() {
      ...
      if (elBd[0]) {
        ...
        for (var _i5 = 0; _i5 < elBd.length; _i5++) {
          dom.removeEventListener(elBd[_i5], namestart, this._onClickGroup0Start, true);
          dom.removeEventListener(elBd[_i5], nameend, this._onClickGroup0End, true);
          dom.removeEventListener(elBd[_i5], namestart, mobile_onTouchstart_picker, true);
          dom.removeEventListener(elBd[_i5], namemove, mobile_onTouchmove_picker, true);
          dom.removeEventListener(elBd[_i5], nameend, mobile_onTouchend_picker, true);
          dom.removeEventListener(elBd[_i5], namecancel, mobile_onTouchcancel_picker, true);
          dom.addEventListener(elBd[_i5], namestart, mobile_onTouchstart_picker, true); // elBd[i].addEventListener(namemove, mobile_onTouchmove_picker, true);
          ...
          if (_i5 == 0 && this.multiple && this.groupCount == 1) {
            dom.addEventListener(elBd[_i5], namestart, this._onClickGroup0Start, true);
            dom.addEventListener(elBd[_i5], nameend, this._onClickGroup0End, true);
          }
          ...
          if (!this.isMobile) {
            ...
            if (/.*Firefox.*/.test(agent)) {
              dom.removeEventListener(elBd[_i5], 'DOMMouseScroll', mobile_onWheel_picker, true);
              dom.addEventListener(elBd[_i5], 'DOMMouseScroll', mobile_onWheel_picker, true);
            } else {
              dom.removeEventListener(elBd[_i5], 'mousewheel', mobile_onWheel_picker, true);
              dom.addEventListener(elBd[_i5], 'mousewheel', mobile_onWheel_picker, true);
            }
          }
        }
      } // if.
    ...
    */
    ...
    _refreshDatasource: function _refreshDatasource() {
      ...
      if (this.realDatasource) {
        ...
        this.groupCount = 1;
        var p = utils.sleep(1).then(this.refreshDatasource(0, trigger));
        this.$nextTick(function () {
          var _this14 = this;
